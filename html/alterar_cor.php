...
<body style="background-color: #1C1C1C; font-family: 'Quicksand', sans-serif; position: relative;">
    ...
    <nav class="navbar navbar-dark" style="background-color: #000000;">
        <div class="container-fluid">
            <a href="cores_cadastradas.php">
                <img src="../img/navbar/back.png" alt="Bootstrap" width="25" height="25">
            </a>
            <a class="navbar-brand" style="margin-right: 0; font-size: 20px;">Alterar Cor</a>
    ...
    <div class="d-block" style="margin: 5%;">
        <div class="card text-center">
            <div class="card-header">
                <h5 style="margin-top: 2%; margin-bottom: -4%;"><?php echo $stmt[0]['hex'] ?></h5>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-center p-2">
                    ...
                    id="exampleColorInput" value="<?php echo $stmt[0]['hex'] ?>" style="margin-top: -3%;" name="cor">
                        <input type="text" value="<?php echo $stmt[0]['idcor'] ?>" style="margin-top: -3%;"  name="idcor" hidden>
                </div>
                <div class="d-flex justify-content-center p-2" style="margin-top: 2%;">
